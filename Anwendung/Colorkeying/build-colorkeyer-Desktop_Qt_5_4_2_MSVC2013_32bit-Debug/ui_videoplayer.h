...
public:
    ...
    void setupUi(QMainWindow *VideoPlayer)
    {
        ...
        HueMax->setGeometry(QRect(420, 460, 160, 19));
        ...
        SatMax->setGeometry(QRect(420, 500, 160, 19));
        ...
        ValueMax->setGeometry(QRect(420, 540, 160, 19));
        ...
        label_2->setGeometry(QRect(470, 430, 47, 13));
