...
public:
    ...
    void setupUi(QMainWindow *asdf)
    {
        if (asdf->objectName().isEmpty())
            asdf->setObjectName(QStringLiteral("asdf"));
        asdf->setWindowModality(Qt::NonModal);
        asdf->setEnabled(true);
        asdf->resize(740, 772);
        asdf->setAutoFillBackground(false);
        asdf->setStyleSheet(QStringLiteral(""));
        centralWidget = new QWidget(asdf);
        ...
        asdf->setCentralWidget(centralWidget);

        retranslateUi(asdf);

        QMetaObject::connectSlotsByName(asdf);
    } // setupUi

    void retranslateUi(QMainWindow *asdf)
    {
        asdf->setWindowTitle(QApplication::translate("asdf", "MainWindow", 0));
        filtertypeCombobox->clear();
        filtertypeCombobox->insertItems(0, QStringList()
         << QApplication::translate("asdf", "Lowpass", 0)
         << QApplication::translate("asdf", "Highpass", 0)
         << QApplication::translate("asdf", "Bandpass", 0)
        );
        filtertypeCombobox->setCurrentText(QApplication::translate("asdf", "Lowpass", 0));
        frequencyLabel->setText(QApplication::translate("asdf", "frequencyLabel", 0));
        label->setText(QApplication::translate("asdf", "Q", 0));
        label_3->setText(QApplication::translate("asdf", "Attack", 0));
        label_4->setText(QApplication::translate("asdf", "Hold", 0));
        label_6->setText(QApplication::translate("asdf", "Release", 0));
        label_9->setText(QApplication::translate("asdf", "Position", 0));
        label_10->setText(QApplication::translate("asdf", "Position Randomize", 0));
        label_11->setText(QApplication::translate("asdf", "Spread", 0));
        label_12->setText(QApplication::translate("asdf", "Rate", 0));
        label_13->setText(QApplication::translate("asdf", "Gain-Envelope", 0));
        label_14->setText(QApplication::translate("asdf", "Filter:", 0));
        label_5->setText(QApplication::translate("asdf", "Hz", 0));
        openWAVButton->setText(QApplication::translate("asdf", "Open WAV", 0));
        labelAttack->setText(QString());
        labelHold->setText(QString());
        labelRelease->setText(QString());
        label_15->setText(QApplication::translate("asdf", "Volume", 0));
        label_16->setText(QApplication::translate("asdf", "Volume Randomize", 0));
        label_2->setText(QApplication::translate("asdf", "Granular Synthesizer", 0));
    } // retranslateUi

};

namespace Ui {
    class asdf: public Ui_asdf {};
} // namespace Ui
